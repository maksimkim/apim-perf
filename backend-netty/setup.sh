...
openssl req -new -keyout server.key -nodes -newkey rsa:2048 -subj "/CN=apim-httpperf.westus.cloudapp.azure.com" | openssl x509 -req -CA key server_ca.key -CA server_ca.pem -days 36500 -set_serial $RANDOM -sha512 -out server.pem
